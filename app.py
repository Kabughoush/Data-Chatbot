...
if "OPENAI_API_KEY" not in st.secrets:
    ...
    # Function to read table descriptions from the CSV file
    def get_table_descriptions(file_path):
        table_descriptions = pd.read_csv(file_path)
        descriptions = ""
        for _, row in table_descriptions.iterrows():
            descriptions += f"Table Name: {row['Table']}\nDescription: {row['Description']}\n\n"
        return descriptions

    # Get table descriptions
    table_descriptions = get_table_descriptions("table_descriptions.csv")
